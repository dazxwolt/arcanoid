...
function ArkanoidGame(canvas, context) {
	...
	this.bricks = new Bricks(16, 2, BRICK_WIDTH, BRICK_HEIGHT);
	...
	this.initLevel = function(level) {
		switch (level) {
			...
			case 2:
				this.bricks = new Bricks(16, 4, BRICK_WIDTH, BRICK_HEIGHT);
				for (var i = 0; i < this.bricks.bricks.length; i++) {
					for (var j = 0; j < this.bricks.bricks[i].length; j++) {
						this.bricks.bricks[i][j].lifes = BricksTypes.DEFAULT + i;
					}
			...
			case 3:
				this.bricks = new Bricks(16, 5, BRICK_WIDTH, BRICK_HEIGHT);
				for (var i = 0; i < this.bricks.bricks.length; i++) {
					for (var j = 0; j < this.bricks.bricks[i].length; j++) {
						this.bricks.bricks[i][j].lifes = BricksTypes.DEFAULT + i;
					}
			...
			for (var j = 0; j < this.bricks.bricks[i].length; j++) {
				if (this.bricks.bricks[i][j].lifes > 0) {
					switch (this.bricks.bricks[i][j].lifes) {
						case BricksTypes.ICE: context.fillStyle = 'rgba(127,255,212,0.9)'; break;
						case BricksTypes.WOOD: context.fillStyle = 'rgb(140,79,27)'; break;
						case BricksTypes.STONE: context.fillStyle = 'rgb(128,128,128)'; break;
						case BricksTypes.IRON: context.fillStyle = 'rgb(172,172,85)'; break;
						case BricksTypes.STEEL: context.fillStyle = 'rgb(115,133,149)'; break;
